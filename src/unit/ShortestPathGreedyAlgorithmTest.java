...
public class ShortestPathGreedyAlgorithmTest {
	...
	final String originalSequence = "This part of the\n"
	...
	final String newSequence = 	"This is an important\n"
			+ "notice! It should\n"
	...
	final String normalDiffOutput = "0a1,6\n"
	...
	public void diff_abcabba_cbabac_1D2D3IB6D7IC() {
		...
		assertEquals(expectedScript, formatter.format(editCommands));
	}
	...
	public void diff_lines_() {		
		...
		assertEquals(normalDiffOutput, formatter.format(editCommands));
	}
}
